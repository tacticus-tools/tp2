...
export const TacticusGuildRole = {
	MEMBER: 0,
	OFFICER: 1,
	CO_LEADER: 2,
	LEADER: 3,
} as const;
export type TacticusGuildRole =
	(typeof TacticusGuildRole)[keyof typeof TacticusGuildRole];
...
export const TacticusEncounterType = {
	SideBoss: 0,
	Boss: 1,
} as const;
export type TacticusEncounterType =
	(typeof TacticusEncounterType)[keyof typeof TacticusEncounterType];

export const TacticusDamageType = {
	Bomb: 0,
	Battle: 1,
} as const;
export type TacticusDamageType =
	(typeof TacticusDamageType)[keyof typeof TacticusDamageType];
