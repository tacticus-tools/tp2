		...
		<div className="space-y-12 py-8">
			<div className="text-center">
				<div className="mb-4 flex items-center justify-center gap-3">
					<div className="flex size-14 items-center justify-center rounded-2xl bg-linear-to-br from-cyan-600 to-blue-700 text-2xl font-bold text-white shadow-lg shadow-cyan-500/20">
						T
					</div>
				</div>
