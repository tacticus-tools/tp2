...
const config = defineConfig({
	...
	plugins: [
		...
		{ name: "prepareXpLevelData", buildStart: prepareXpLevelData }, // References: <None>
		{ name: "prepareAbilityCostData", buildStart: prepareAbilityCostData }, // References: <None>
		{ name: "prepareGuildWarData", buildStart: prepareGuildWarData }, // References: <None>
		...
		{ name: "prepareFactionData", buildStart: prepareFactionData }, // References: Characters[FactionIds]
		{
